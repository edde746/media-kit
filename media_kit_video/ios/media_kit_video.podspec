...
Pod::Spec.new do |s|
  ...
  if mku.libs_found
    ...
    s.pod_target_xcconfig = {
      ...
      'OTHER_LDFLAGS'                                => '"$(inherited)" -framework Mpv -framework Libavcodec -framework Libavdevice -framework Libavfilter -framework Libavformat -framework Libavutil -framework Libswresample -framework Libswscale -framework Libass -framework Libuchardet -lMoltenVK -framework Libplacebo -framework Libfreetype -framework Libfribidi -framework Libharfbuzz -framework gmp -framework Libuavs3d -framework Libshaderc_combined -framework Libunibreak -framework gnutls -framework nettle -framework hogweed -framework lcms2 -framework Libdav1d -framework Libdovi -framework Libbluray -lxml2 -lz -liconv -lbz2 -framework CoreText -framework UIKit -framework Metal -framework MetalKit -framework CoreMedia -framework VideoToolbox -framework AudioToolbox -framework AVFoundation -framework Foundation -framework CoreFoundation -framework Security -framework SystemConfiguration -framework Network',
